        ...
        <form id="ajax-reg" method="post" enctype="multipart/form-data" class="wizard-form steps-validation"
            ...
            <fieldset>
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input value="{{ old('father_name') }}" class="form-control" placeholder="Father's Name"
                                name="father_name" type="text" required>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label>Mother's Name: <span class="text-danger">*</span></label>
                            <input value="{{ old('mother_name') }}" class="form-control" placeholder="Mother's Name"
                                name="mother_name" type="text" required>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label>Father's Mob: <span class="text-danger">*</span></label>
                            <input value="{{ old('father_no') }}" class="form-control" placeholder="Father's Mob"
                                name="father_no" type="number" required>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label>Mother's Mob: <span class="text-danger">*</span></label>
                            <input value="{{ old('mother_no') }}" class="form-control" placeholder="Mother's Mob"
                                name="mother_no" type="number" required>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label>Student ID: <span class="text-danger">*</span></label>
                            <select class="select form-control"  name="student_id" required data-fouc
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input value="{{ old('aadhaar') }}" class="form-control" placeholder="Aadhaar No"
                                name="adhar_no" type="number" required>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label>Phone:</label>
                            <input value="{{ old('phone') }}" type="number" name="phone" class="form-control"
                                placeholder="Phone">
                        </div>
                    </div>
            ...
            <fieldset>
                ...
                <div class="row">
                    ...
                    <input type="hidden" name="dorm_room_no" placeholder="Dormitory Room No" class="form-control"
                        value="501">
                    <input type="hidden" name="house" placeholder="Sport House" class="form-control" value="105">
